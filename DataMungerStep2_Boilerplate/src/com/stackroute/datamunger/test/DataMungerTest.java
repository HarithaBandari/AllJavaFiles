...
public class DataMungerTest {
	...
	public void testGetFieldsAndRestrictions() {
		...
		assertEquals(
				...
				restrictionsList.toString(), queryParameter.getRestriction().toString());
	...
	public void testGetFieldsAndRestrictionsFailure() {
		...
		List<Restriction> restrictions = queryParameter.getRestriction();
	...
	public void testGetGroupByClause() {
		...
		assertEquals(
				...
				null, queryParameter.getRestriction());
	...
	public void testGetOrderByAndWhereConditionClause() {
		...
		assertEquals(
				...
				restrictionList.toString(), queryParameter.getRestriction().toString());
		assertEquals(
